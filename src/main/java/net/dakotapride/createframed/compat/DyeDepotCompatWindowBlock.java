...
public class DyeDepotCompatWindowBlock extends WindowBlock {
    boolean fromDyeDepot;
    public DyeDepotCompatWindowBlock(boolean fromDyeDepot, Properties properties, boolean translucent) {
