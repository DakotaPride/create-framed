...
public abstract class DyedFrogportBlock extends Block implements IBE<DyedFrogportBlockEntity>, IWrenchable {

    public DyedFrogportBlock(Properties pProperties) {
        super(pProperties);
    }
    ...
    @Override
    public Class<DyedFrogportBlockEntity> getBlockEntityClass() {
        return DyedFrogportBlockEntity.class;
    }
