...
public class OrangeFrogportVisual extends DyedFrogportVisual {
    public OrangeFrogportVisual(VisualizationContext ctx, DyedFrogportBlockEntity blockEntity, float partialTick) {
        super(ctx, blockEntity, partialTick, CreateFramedPartialModels.ORANGE_FROGPORT_BODY,
