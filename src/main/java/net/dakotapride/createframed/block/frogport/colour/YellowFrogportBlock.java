...
public class YellowFrogportBlock extends DyedFrogportBlock {
    public YellowFrogportBlock(Properties pProperties) {
        super(pProperties);
    }

    @Override
    public BlockEntityType<? extends DyedFrogportBlockEntity> getBlockEntityType() {
        return CreateFramedEntityTypes.YELLOW_FROGPORT.get();
    }
}
